...
namespace Fit.Infrastructure.Migrations
{
    ...
    [Migration("20250210231458_Create-Initial-Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fit.Domain.Entities.UserEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Fit.Domain.Entities.UserEntity", b =>
                {
                    b.HasOne("Fit.Domain.Entities.UserEntity", "PersonalTrainer")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Fit.Domain.Entities.UserEntity", null)
                        .WithMany()
